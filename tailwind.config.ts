	...
	theme: {
		...
		extend: {
			...
			colors: {
				...
				evidence: {
					digital: 'hsl(var(--evidence-digital))',
					physical: 'hsl(var(--evidence-physical))',
					analysis: 'hsl(var(--evidence-analysis))'
				},
				case: {
					open: 'hsl(var(--case-open))',
					active: 'hsl(var(--case-active))',
					closed: 'hsl(var(--case-closed))',
					archived: 'hsl(var(--case-archived))'
				},
				sidebar: {
